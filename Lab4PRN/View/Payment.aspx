<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Lab4PRN.View.Payment" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container col-11">
            <asp:LinkButton ID="homePage" runat="server" CssClass="background_header" OnClick="homePage_Click"><i class="fa fa-home" aria-hidden="true"></i> Home</asp:LinkButton>

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            <br />
            &nbsp;<asp:Label ID="lb_message" runat="server" Text="" CssClass="text-danger"></asp:Label>
            <br />
            <asp:GridView ID="gridFlightBooked" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" EnableModelValidation="True" ForeColor="Black">
                <Columns>
            ...
            <br />
            <asp:Label ID="lb_total_money" runat="server"></asp:Label>
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Text="Your Feedback"></asp:Label>
            &nbsp;
            <asp:TextBox ID="txt_feed_back" runat="server"></asp:TextBox>
            <br />
            <br />
            ...
            <p>
                ...
                <asp:Label ID="lb_successfully" runat="server" Text="" CssClass="text-success"></asp:Label>
            </p>
